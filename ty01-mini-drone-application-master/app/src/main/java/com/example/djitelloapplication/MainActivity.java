...
public class MainActivity extends AppCompatActivity {
    ...
    private FloatingActionButton selectScenario;
    ...
    private boolean connectionFlag = false; // to check and maintain the connection status of the drone. Initially the drone is not connected, so the status is false
...
//        getSupportActionBar().hide();
        ...
        selectScenario = findViewById(R.id.selectScenario);
        selectScenario.setOnClickListener(v -> {
            Intent scenarioViewScreenIntent = new Intent(MainActivity.this, ScenarioViewActivity.class);
            startActivity(scenarioViewScreenIntent);
        });
        ...
        connection.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                if (connectionClickCounter % 2 == 1){   // to enable switch like behavior to connect and disconnect from the drone
                    ...
                    Toast.makeText(MainActivity.this,"Drone connected",Toast.LENGTH_SHORT).show();
                    connectionFlag = true;              // set the connection status to true
                }
                if (connectionClickCounter % 2 == 0){
                    telloConnect("disconnect");
                    connectionFlag = false;
                    Toast.makeText(MainActivity.this,"Drone disconnected",Toast.LENGTH_SHORT).show();
                }
